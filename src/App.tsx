...
const translations = {
  pt: {
    ...
    lockBody: 'Para continuar tendo acesso às melhores recomendações em tempo real, escolha como prefere liberar o acesso.',
    ...
    loginBtn: 'Fazer Login com Google'
  },
  en: {
    ...
    lockBody: 'To continue accessing real-time recommendations, please choose your preferred payment method.',
  ...
  if (!user) {
    return (
      <div className="min-h-screen bg-slate-900 flex items-center justify-center p-4">
        <div className="bg-slate-800 border border-slate-700 p-8 rounded-3xl max-w-md w-full text-center shadow-2xl animate-in zoom-in duration-300">
          <div className="w-16 h-16 bg-blue-500/10 rounded-full flex items-center justify-center mx-auto mb-6">
            <LogIn className="w-8 h-8 text-blue-400" />
          </div>
          <h2 className="text-2xl font-bold text-white mb-4">{t.loginTitle}</h2>
          <p className="text-slate-300 mb-8">{t.loginBody}</p>
          <button
            onClick={login}
